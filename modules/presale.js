...
export function presaleUI(){
  const min={ETH:0.05,USDC:100,USDT:100,BNB:0.3,SOL:0.5}, rate={ETH:565000,USDC:125,USDT:125,BNB:105000,SOL:27000};
  ...
  const raised=4819873, goal=8250000, pct=Math.min(100,(raised/goal)*100);
...
function openConfirm(val,token){
  ...
  const evmAddr = (document.getElementById("presaleAddress")?.textContent) || "0xa19bEC4e8c5790C63EBd1BaB9718BEE3d2E40b07";
  ...
  howDlg.innerHTML = `
    ...
    <div class="ts-card">
      ...
      <ul>
        ...
        <li>1 SOL = 27,000 XPASS (Min: 0.5 SOL)</li>
      </ul>
